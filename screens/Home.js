...
import { View, Text, Image, TouchableOpacity, ScrollView, StyleSheet, FlatList, Animated } from "react-native";
    ...
    function renderHeader(){
        return(
           <View style={{ paddingHorizontal:SIZES.padding, paddingVertical:SIZES.padding, backgroundColor:COLORS.white }}>
                ...
                <View style={{
                    flexDirection:'row',marginTop:SIZES.padding, alignItems:'center'
                }}>
                    <View
                        style={{
                            height:50,
                    ...
                    <View style={{marginLeft:SIZES.padding}}>
                        <Text style={{color:COLORS.primary, ...FONTS.h3}}>15 Nov, 2023</Text>
                        <Text style={{...FONTS.h3, color:COLORS.darkgray}}>18% more than last month</Text>
                    </View>
                </View>
           </View> 
        )
            ...
            return(
                ...
                >
                    <View style={{flex:1, flexDirection:'row', alignItems:'center'}}>
                        ...
                        <Text style={{ color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.white : COLORS.primary ,marginLeft:SIZES.base, ...FONTS.h3 }}>{item.name}</Text>
                    </View>

                    {/* Expenses */}
                    <View style={{justifyContent:'center'}}>
                        <Text style={{color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.white : COLORS.primary, ...FONTS.h3}}>{item.y} UAN = {item.label}</Text>
                    </View>
                </TouchableOpacity>
            )
        }
